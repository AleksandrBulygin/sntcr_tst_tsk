...
# ACDS 22.1 917 win32 2023.07.04.19:16:59
# ----------------------------------------
...
# ----------------------------------------
# If clockDecrease is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clockDecrease"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clockDecrease.vo"
}
